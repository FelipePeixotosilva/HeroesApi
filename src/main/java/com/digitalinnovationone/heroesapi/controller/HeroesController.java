...
public class HeroesController {
    ...
    HeroesRepository heroesRespository;

    private static final org.slf4j.Logger log =
            org.slf4j.LoggerFactory.getLogger(HeroesController.class);
    public HeroesController (HeroesService heroesService, HeroesRepository heroesRespository) {
    ...
    public Mono <ResponseEntity<Heroes>> findByHero(@PathVariable String id){
        log.info("resqueting the hero with id {}", id);
